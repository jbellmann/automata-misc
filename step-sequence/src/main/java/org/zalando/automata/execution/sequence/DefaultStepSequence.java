...
public class DefaultStepSequence implements StepSequence{
    ...
    public SequenceExecutionResult execute(final Context context) {
        ...
        while(!this.sequence.isEmpty()){
            ...
            final SequenceExecutionStatus status = 
                    sequenceExecutionResult.addStepResult(stepExecutionResult == null ? StepExecutionResult.buildTestSuccessResult(getName()) : stepExecutionResult ,
            ...
            if(status == SequenceExecutionStatus.FAILED){
                ...
                while(!this.sequence.isEmpty()){
                    final Step skippedStep = this.sequence.poll();
